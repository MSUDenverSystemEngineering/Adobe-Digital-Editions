...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\N360"
		...
		Execute-Process -Path 'ADE_4.5_Installer.exe' -Parameters '/S' -WindowStyle 'Hidden'
		...
		Copy-File -Path "$dirSupportFiles\adeupdaterconfig.cfg" -Destination "$envProgramFilesX86\Adobe\Adobe Digital Editions 4.5\adeupdaterconfig.cfg"
		Remove-File -Path "$envCommonDesktop\Adobe Digital Editions 4.5.lnk" -ContinueOnError $true
		Execute-Process -Path "$envSystem32Directory\cscript.exe" -Parameters "`"$dirSupportFiles\RegUpdateAllHkcuHkcr.vbs`" //B //Nologo"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'adeautoupdater_450,digitaleditions,migration' -CloseAppsCountdown 60
		...
		Execute-Process -Path "$envProgramFilesX86\Adobe\Adobe Digital Editions 4.5\uninstall.exe" -Parameters "/s"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCKvENOCUDVZrBX
# VuPd94KebY9yN3C3qnu/F0aMX69rgKCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIAcJ
# pqOOT6VImxToCLLy/f13IaPzjE1ahoknrqsXzeLXMA0GCSqGSIb3DQEBAQUABIIB
# ADS2wgPlLJHKTXputLL2BPWRrk69hiqJbLyyOr4fxxPP80FyymJEheHQkiZrRhKR
# FGY4B3ZVKY94xhAinM+5U4nkOqM9pcYHSFVuGIhiBc+egGSVqDphg4dezSRBzbnB
# GsWeptGcD6cRp/0s8CIYLuP400uLznRoOpRH4HWDki9rQj4Ixa6EyaV6Ox4prQag
# rlVEg7CeI+9wQHbaklKWDiwXbyYeut8rHBBC/gwvGaVYChL5uM8JaKEiRcXwUNlB
# 42N8ObRx/gWFrHPvSXu0ni3f+oE0uiWudqM6KPVhD2345xBVWktr7o58hON3ZE48
# ccpu0gRTe+YJVp3DQJTtcjyhggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTYwODMxMTYxOTI3WjAjBgkqhkiG9w0BCQQxFgQU
# OyWo1Al++6VLPYK0/9k2Cs6nU/AwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBADyRX63jzERAYkq7VNSyeXM1HqICLEYzX+tXG3QbInf7c+fHd06u/9iL
# I2kJ4okzYhrZ2tZxJFrJwUvfe7hnHgTRSVLj6vQbOVWJNioKZalj2MiI7lj0GQmj
# aCoQBZmcDIkYVp4HzYqQD0330K0gIutjqV1jje9AUjncsavowllna/LGLz0CxK78
# Ly0DTXYczGQVfrINn8ZavHwARKT/U4nIo3Oo26rvyqtu+xNjd6eekMQwVFaVKo+T
# /22ouqKfRq5K/VT5z+CF75uem5frhjvZwv4txOCNmg2dXfFke/b+ud9i8UrxeL10
# Twpu1Wkh3ZKo4OWn9Yi/aV5NdmfjirQ=
