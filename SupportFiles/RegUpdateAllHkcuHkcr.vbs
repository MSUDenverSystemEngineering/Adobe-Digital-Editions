...
Sub KeysToModify(sRegistryRootToUse, DAT_FILE)
	...
	If DAT_FILE = DAT_NTUSER Then 'This is for updating HKCU keys
		...
		strRegPathParent01 = "Software\Adobe\Adobe Digital Editions 4.5"
    'strRegPathParent02 = ""
    'strRegPathParent03 = ""

		WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\ConfigPath", "C:\\Program Files (x86)\\Adobe\\Adobe Digital Editions 4.5\\adeupdaterconfig.cfg", "REG_SZ"
    WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\EnableAutoUpdate", "0", "REG_SZ"
    WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\UpdateInterval", "0", "REG_SZ"
    WshShell.RegWrite sRegistryRootToUse & "\" & strRegPathParent01 & "\ReaderState", "0", "REG_SZ"
